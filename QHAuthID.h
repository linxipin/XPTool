 ...
 *  TouchID/FaceID 状态
 */
typedef NS_ENUM(NSUInteger, QHAuthIDState){
...
@interface QHAuthID : LAContext

typedef void (^QHAuthIDStateBlock)(QHAuthIDState state, NSError *error);
 ...
 */
- (void)qh_showAuthIDWithDescribe:(nullable NSString *)describe block:(QHAuthIDStateBlock)block;
